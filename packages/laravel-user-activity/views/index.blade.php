...
<head>
    ...
    <style>
        ...
        .content select, .content input, .content button {
...
<body ng-controller="LogCtrl">
    <header>
        <div class="name">
            <span style="background: #FFC107; padding: 10px;"><img src="{{ asset('img/logo3.png') }}"
                alt="" width="100px"></span>
            {{-- <span class="letter_a">T</span> <span>.lk</span> --}}
        </div>
        <div class="actions">
                ...
                <div class="filter_item">
                    ...
                    <select ng-model="filter.table">
                        @foreach($tables as $table)
                            <option value="{{ $table}}">{{ trans('tables.'.$table)}}</option>
                        @endforeach
                    </select>
                </div>
                <div class="filter_item">
