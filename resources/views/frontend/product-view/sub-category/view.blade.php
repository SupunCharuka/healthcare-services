                ...
                <div class="col-md-7 col-sm-12">
                    <div class="lower-content">
                        <ul class="bread-crumb clearfix">
                            ...
                            <li class="ml-1"><a
                                    href="{{ route('public.productSub', ['product' => $category->productCategory]) }}">{{ $category->productCategory->name }}
                                    </a>
                            </li>
                            <li class="ml-1">{{ $category->name }}</li>
                        </ul>
                    </div>
                </div>
                <div class="col-md-4 col-sm-12">
                    <div class="sidebar-widget sidebar-search">
                        <div class="search-inner">
                            <form action="{{ route('public.viewSub',['category' => $category]) }}" method="get" class="search-form">
