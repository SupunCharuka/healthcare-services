    ...
    <div class="md:mt-0 md:col-span-2">
        ...
        <form wire:submit.prevent="store" class="theme-form" enctype="multipart/form-data">
            ...
            <div class="px-4 py-3 bg-white sm:p-6 shadow sm:rounded-tl-md sm:rounded-tr-md">
                ...
                <div class="row">
                    <div class="col-6 col-span-6 sm:col-span-4 mt-2">
                        <label class="block font-medium text-sm text-gray-700" for="name">
                ...
                <div class="form-group row mb-2 mt-2">
                    ...
                    <div x-data="{ isUploading: false, progress: 0 }" x-on:livewire-upload-start="isUploading = true"
                        ...
                        <!-- File Input -->
                        <input wire:model="document" id="dile" class="form-input border-gray-300 focus:border-indigo-300 focus:ring focus:ring-indigo-200 focus:ring-opacity-50 rounded-md shadow-sm mt-1 block w-full px-1 py-1" type="file" accept="image/*,application/pdf">
                        <input id="old_dile" type="hidden" value="{{ $education->file }}">
                        <!-- Progress Bar -->
                        ...
                        @elseif($education->file)
                            ...
                            @if (in_array($extension, $imageExtensions,true))
                                <img class="img-thumbnail mt-2"
                                     src="{{ asset('uploads/service-provider/education/' . $education->file) }}" style="width:300px"
                                     alt="">
                            @else
                                <b>
