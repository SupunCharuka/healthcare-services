        ...
        <form wire:submit.prevent="save">
            <div class="px-4 py-3 bg-white sm:p-6 shadow sm:rounded-tl-md sm:rounded-tr-md">
                <div class="card-header bg-white px-1 py-1">
                    <h5 class="py-1 font-weight-bold">Edit Category</h5>
                </div>
                <div class="grid grid-cols-6 gap-6 mt-4">
                    ...
                    <div class="col-span-6 sm:col-span-4 mt-4">
                        ...
                        <input wire:model.lazy="category.name"
                    ...
                    <div class="col-span-6 sm:col-span-4 mt-1">
                        ...
                        <input wire:model.lazy="category.caption"
                            class="form-input border-gray-300 focus:border-indigo-300 focus:ring focus:ring-indigo-200 focus:ring-opacity-50 rounded-md shadow-sm mt-1 block w-full"
                            id="name" type="text" autofocus="autofocus" data-bs-original-title=""
                            title="">
                        @error('category.caption')
                            <span class="text-danger mt-2">{{ $message }}</span>
                        @enderror
                    </div>
                    {{-- <div class="col-span-6 sm:col-span-4 mt-1">
                        <label class="block font-medium text-sm text-gray-700" for="commission">
                            Commission
                        </label>
                        <input wire:model.lazy="category.commission"
                            class="form-input border-gray-300 focus:border-indigo-300 focus:ring focus:ring-indigo-200 focus:ring-opacity-50 rounded-md shadow-sm mt-1 block w-full"
                            id="commission" type="text">
                        @error('category.commission')
                            <span class="text-danger mt-2">{{ $message }}</span>
                        @enderror
                    </div> --}}
                    {{-- <div class="col-span-6 sm:col-span-4 mt-1">
                        <label class="block font-medium text-sm text-gray-700" for="video_id">
                            Video URL
                        </label>
                        <div class="relative">
                            <input wire:model.lazy="category.video_id"
                                class="form-input border-gray-300 focus:border-indigo-300 focus:ring focus:ring-indigo-200 focus:ring-opacity-50 rounded-md shadow-sm mt-1 block w-full"
                                id="video_id" type="text" autofocus="autofocus" data-bs-original-title=""
                                title="">

                        </div>
                        @error('category.video_id')
                            <span class="text-danger mt-2">{{ $message }}</span>
                        @enderror
                    </div> --}}
                    {{-- <div class="col-span-6 sm:col-span-4 mt-1">
                        <label class="block font-medium text-sm text-gray-700" for="video_id_si">
                            Sinhala Video URL
                        </label>
                        <div class="relative">
                            <input wire:model.lazy="category.video_id_si"
                                   class="form-input border-gray-300 focus:border-indigo-300 focus:ring focus:ring-indigo-200 focus:ring-opacity-50 rounded-md shadow-sm mt-1 block w-full"
                                   id="video_id_si" type="text" autofocus="autofocus" data-bs-original-title=""
                                   title="">

                        </div>
                        @error('category.video_id_si')
                        <span class="text-danger mt-2">{{ $message }}</span>
                        @enderror
                    </div> --}}
                    ...
                    <div class="col-span-6 sm:col-span-4 mt-1">
                        ...
                        <textarea wire:model.lazy="category.description" id="description" type="text"
                    ...
                    <div class="col-span-6 sm:col-span-4 mt-1">
                        ...
                        @elseif(!empty($category->image))
                            <img class="mt-2" src="{{ asset("uploads/admin/service-category/$category->image") }}" width="50"
                                alt="">
                        @endif
                        @error('image')
