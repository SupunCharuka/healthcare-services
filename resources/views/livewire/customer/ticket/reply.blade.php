<div>
          ...
          <div class="col">
             ...
             @if (!empty($reply->attachment))
                <p>
                   ...
                   <a href="{{ storage('uploads/service-provider/ticket/reply/' . $reply->attachment) }}" target="blank">
                      View File 
                   </a>
                </p>
             @endif
    ...
    <form wire:submit.prevent="reply" method="POST">
       ...
       <div class="form-group">
          ...
          <textarea wire:model.lazy="reply.reply" class="form-control" id="comment_text" name="reply_body" rows="3" required></textarea>
          @error('reply.reply')
          ...
          @if (!$errors->has('attachment'))
             ...
             @elseif(!$attachment && $reply->attachment)
                ...
                @if (in_array($extension, $imageExtensions))
                   <img class="img-thumbnail mt-2" src="{{ storage('uploads/service-provider/ticket/' . $reply->attachment) }}" style="width:300px" alt="">
                @else
                   <b>
                      Current PDF : <br> <img src="https://img.icons8.com/fluency/48/000000/pdf-mail.png" />
                   </b>
                   <a href="{{ storage('uploads/service-provider/ticket/' . $reply->attachment) }}" target="blank">
                      {{ $reply->attachment }}
                   </a>
                @endif
             @endif
