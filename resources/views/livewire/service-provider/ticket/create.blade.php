    ...
    <div class="md:mt-0 md:col-span-2">
        ...
        <form wire:submit.prevent="store" class="theme-form" enctype="multipart/form-data">
            <div class="px-4 py-3 bg-white sm:p-6 shadow sm:rounded-tl-md sm:rounded-tr-md">
                ...
                <div class="row">
                    <div class="col-12 col-span-12 sm:col-span-4 mt-4">
                ...
                <div class="form-group row mb-2 mt-4">
                    <label class="control-label" for="document" id="bank-upload-image">Ticket attachments<span class="text-danger">*</span></label>
                        ...
                        @elseif($ticket->file)
                            ...
                            @if (in_array($extension, $imageExtensions,true))
                                <img class="img-thumbnail mt-2"
                                     src="{{ storage('uploads/service-provider/ticket/' . $ticket->file) }}" style="width:300px"
                                     alt="">
                            @else
                                <b>
