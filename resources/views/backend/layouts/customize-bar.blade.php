        ...
        <div class="customizer-body custom-scrollbar">
            <div class="tab-pane fade show active" id="c-pills-home" role="tabpanel" aria-labelledby="c-pills-home-tab">
                ...
                <ul class="sidebar-type layout-grid">
                    <li data-attr="normal-sidebar" class="active">
                        <div class="header bg-light">
                            <ul>
                                <li></li>
                                <li></li>
                    ...
                    <li data-attr="compact-icon-sidebar">
                        <div class="header bg-light">
                            <ul>
                                <li></li>
                                <li></li>
                ...
                <ul class="nav nac-pills" id="pills-tab" role="tablist">
                    <li class="nav-item"><a class="nav-link active show" id="pills-home-tab" data-bs-toggle="pill"
                            href="#pills-home" role="tab" aria-controls="pills-home" aria-selected="true"
                            data-original-title="" title="">Color</a></li>
                    <li class="nav-item"><a class="nav-link" id="pills-profile-tab" data-bs-toggle="pill"
                            ...
                            data-original-title="" title="">Pattern</a></li>
            ...
            <div class="tab-pane fade " id="c-pills-profile" role="tabpanel" aria-labelledby="c-pills-profile-tab">
                ...
                <ul class="layout-grid customizer-color">
                    ...
                    <li class="color-layout" data-attr="color-2" data-primary="#0288d1" data-secondary="#26c6da">
                        <div></div>
                    </li>
                    <li class="color-layout" data-attr="color-3" data-primary="#8e24aa" data-secondary="#ff6e40">
                        <div></div>
                    </li>
                ...
                <ul class="layout-grid customizer-mix">
                    <li class="color-layout" data-attr="light-only">
                        <div class="header bg-light">
                            <ul>
                                <li></li>
                                <li></li>
                    ...
                    <li class="color-layout active" data-attr="">
                        <div class="header bg-light">
                            <ul>
                                <li></li>
                                <li></li>
                    ...
                    <li class="color-layout" data-attr="dark-body-only">
                        <div class="header bg-light">
                            <ul>
                                <li></li>
                                <li></li>
                    ...
                    <li class="color-layout" data-attr="dark-sidebar-body-mix">
                        <div class="header bg-light">
                            <ul>
                                <li></li>
                                <li></li>
                    ...
                    <li class="color-layout" data-attr="dark-header-sidebar-mix">
