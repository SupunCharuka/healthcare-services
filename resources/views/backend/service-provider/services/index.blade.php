<x-backend-layout>
    ...
    <div>
        <div class="container-fluid">
            <div class="row">
                <div class="col-sm-12">
                    <livewire:service-provider.service.create />
                </div>
                <div class="col-sm-12">
                    <div class="card shadow">
                        ...
                        <div class="card-body">
                            <div class="table-responsive">
                                <table class="table table-striped table-bordered dt-responsive nowrap" id="service"
                                    style="width:100%">
                                    <thead>
                                        <tr>
                                            <th>Id</th>
                                            ...
                                            <tr id="service-record-{{ $service->id }}">
                                                ...
                                                <td class="text-center">
                                                    <a class="btn btn-sm btn-primary"
                                                        href="{{ URL::signedRoute('service-provider.service.index.edit', ['service' => $service]) }}">
    ...
    <x-slot name="scripts">
        ...
        <script src="{{ asset('js/service-provider/services/service.js') }}"></script>
