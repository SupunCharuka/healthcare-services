<x-backend-layout>
    @section('title', 'Unpaid | Commission Payout')
    <x-slot name="styles">
    ...
    <x-slot name="breadcrumb_title">
        Unpaid | Commission Payout
    </x-slot>

    <x-slot name="breadcrumb_items">
        <li class="breadcrumb-item"><a href="{{ route('admin.dashboard') }}">Dashboard</a></li>
        <li class="breadcrumb-item active">Unaid | Commission Payout</li>
    </x-slot>
    <div>
        <div class="row">
            <div class="col-sm-12">
                    ...
                    <div class="card-body">
                        <div class="table-responsive">
                            <table class="table table-striped table-bordered dt-responsive nowrap display"
                                ...
                                <tbody>
                                    @foreach ($inquiriesWithUnpaidCommissions as $key => $inquiry)
