...
@section('breadcrumb-items')
   ...
   <li class="breadcrumb-item"><a href="{{ route('service-provider.adminTickets.index') }}">Tickets</a></li>
               ...
               <div class="card">
                  <div class="card">
                     ...
                     <div class="card-body">
                        ...
                        <a class="bg-color1 btn my-2 text-white" href="{{ route('service-provider.adminTickets.index') }}"> Back to list </a>
