                    ...
                    <div class="owl-carousel owl-theme" id="owl-carousel-14">
                        <div class="card o-hidden">
                            <div class="bg-primary b-r-4 card-body">
                                <div class="media static-top-widget">
                                    ...
                                    <div class="media-body"><span class="m-0">Total Doctors</span>
                                        <h4 class="mb-0 counter">{{ $doctorTotal }}</h4><i class="icon-bg"
                        ...
                        <div class="card o-hidden">
                            <div class="bg-primary b-r-4 card-body">
                                <div class="media static-top-widget">
                                    <div class="align-self-center text-center"><i data-feather="dollar-sign"></i></div>
                                    <div class="media-body"><span class="m-0">Pending Doctors</span>
                                        <h4 class="mb-0 counter">{{ $pendingDoctorTotal }}</h4><i class="icon-bg"
                                            data-feather="dollar-sign"></i>
                                    </div>
                                </div>
                            </div>
                        ...
                        <div class="card o-hidden">
                            <div class="bg-secondary b-r-4 card-body">
                                <div class="media static-top-widget">
                                    ...
                                    <div class="media-body"><span class="m-0">Total Service Provider</span>
                                        <h4 class="mb-0 counter">{{ $serviceProviderTotal }}</h4><i class="icon-bg" data-feather="map-pin"></i>
                                    </div>
                                </div>
                            </div>
                        </div>
                        <div class="card o-hidden">
                            <div class="bg-secondary b-r-4 card-body">
                                <div class="media static-top-widget">
                                    <div class="align-self-center text-center"><i data-feather="map-pin"></i></div>
                                    <div class="media-body"><span class="m-0">Pending Service Provider</span>
                                        <h4 class="mb-0 counter">{{ $pendingServiceProviderTotal }}</h4><i class="icon-bg" data-feather="map-pin"></i>
                                    </div>
                                </div>
                            </div>
                        </div>
                        <div class="card o-hidden">
                            <div class="bg-primary b-r-4 card-body">
                                <div class="media static-top-widget">
                                    ...
                                    <div class="media-body"><span class="m-0">Total Inquiry</span>
                                        <h4 class="mb-0 counter">{{ $inquiryTotal }}</h4><i class="icon-bg"
                            ...
                            <div class="bg-primary b-r-4 card-body">
                                <div class="media static-top-widget">
                                    ...
                                    <div class="media-body"><span class="m-0">Total Orders</span>
                                        <h4 class="mb-0 counter">{{ $orderTotal }}</h4><i class="icon-bg"
                            ...
                            <div class="bg-secondary b-r-4 card-body">
                                <div class="media static-top-widget">
                                    ...
                                    <div class="media-body"><span class="m-0">Total Product</span>
                                        <h4 class="mb-0 counter">{{ $productTotal }}</h4><i class="icon-bg" data-feather="box"></i>
                                    </div>
                                </div>
                            </div>
                        </div>
                        <div class="card o-hidden">
                            <div class="bg-primary b-r-4 card-body">
                                <div class="media static-top-widget">
                                    ...
                                    <div class="media-body"><span class="m-0">Total Completed Orders</span>
                                        <h4 class="mb-0 counter">{{ $total_sales }}</h4><i class="icon-bg"
                        ...
                        <div class="card o-hidden">
                            <div class="bg-primary b-r-4 card-body">
                                <div class="media static-top-widget">
                                    <div class="align-self-center text-center"><i data-feather="message-square"></i></div>
                                    <div class="media-body"><span class="m-0">Total Sale Product</span>
                                        <h4 class="mb-0 counter">{{ $saleProductCount }}</h4><i class="icon-bg"
                                            data-feather="message-square"></i>
                                    </div>
                                </div>
                            </div>
                        ...
                        <div class="card o-hidden">
                            <div class="bg-secondary b-r-4 card-body">
                                <div class="media static-top-widget">
                                    <div class="align-self-center text-center"><i data-feather="box"></i></div>
                                    <div class="media-body"><span class="m-0">Total Sarvice</span>
                                        <h4 class="mb-0 counter">{{ $serviceProviderTotal }}</h4><i class="icon-bg" data-feather="box"></i>
                                    </div>
                                </div>
                            </div>
                        </div>
