<x-backend-layout>
    @section('title', 'Unpaid Commissions')
    <x-slot name="styles">
    ...
    <x-slot name="breadcrumb_items">
        ...
        <li class="breadcrumb-item active">Unpaid Commissions</li>
    </x-slot>
    <div>
        <div class="row">
            <div class="col-sm-12">
            ...
            $(function() {
                $("#datepicker").datepicker({
                    ...
                    onSelect: function(dateText, inst) {
                        window.location.href = "{{ route('admin.commission.notPaid') }}?date=" + dateText;
                    }
                });
            });
        </script>
