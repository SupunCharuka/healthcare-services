...
class ChatBody extends Component
{
    ...
    public $selectedInquiryId;
    protected $listeners = ['selectInquiry' => 'selectInquiry'];
    public $messages = [];
    public $message;
    public $attachment;
    public $lastSeen;
    ...
    public function selectInquiry($inquiryId)
    {
        ...
        $this->selectInquiry = Inquiry::find($this->selectedInquiryId);
    ...
    {
        $this->messages = InquiryConversation::where('inquiry_id', $this->selectedInquiryId)->get();
    }
    ...
    {
        if ($this->selectInquiry && $this->selectInquiry->receiver) {
            return $this->selectInquiry->receiver->updated_at->diffForHumans();
        }
    ...
    public function sendMessage()
    {
        ...
        if ($this->attachment) {
            ...
            $message = InquiryConversation::create([
                'inquiry_id' => $this->selectedInquiryId,
                'sender_id' => auth()->id(),
                'receiver_id' => $this->selectInquiry->user_id,
                'text' => $this->message,
                'status' => 'sent',
                'type' => $type,
    ...
    {
        return view('livewire.service-provider.message.chat-body');
    }
}
